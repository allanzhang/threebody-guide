...
- [x] 真实图片接入：腾讯剧版角色肖像 8 张（汪淼/史强/叶文洁/常伟思/申玉菲/杨冬/丁仪/潘寒）+ 危机纪元头图 + 《三体》书封（TMDB 官方素材本地化，含来源声明；key 存 .env.local 不入库）
- [x] 图片接入机制：portrait / image / hero / cover 覆写 + 同名替换；validator self-test 含图片文件缺失门禁
- [ ] 后续可补：其余事件剧照（剧版仅覆盖第一部，书2/3 无剧版影像维持科学符号占位图）
